    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LineReference", x => new { x.ReferenceId, x.UsableLinesLineId });
                    table.ForeignKey(
                        name: "FK_LineReference_Lines_UsableLinesLineId",
                        column: x => x.UsableLinesLineId,
                        principalTable: "Lines",
                        principalColumn: "LineId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LineReference_References_ReferenceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LineReference_UsableLinesLineId",
                table: "LineReference",
                column: "UsableLinesLineId");
